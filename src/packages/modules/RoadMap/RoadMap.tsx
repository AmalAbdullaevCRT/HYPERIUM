  ...
  return (
    <div className={styles.roadmap} >
        <div className={styles.roadmap_timeline}>
          {!isMobile && <div className={styles.roadmap_timeline_wrapper}>
        ...
        <div className={styles.roadmap_content_wrapper}>
          <div className={styles.roadmap_content}>
            <div className={styles.roadmap_content_item}>
              <div className={styles.roadmap_content_mobile_timeline_item}>01</div>
              <div>
            ...
            <div className={styles.roadmap_content_item}>
              <div className={styles.roadmap_content_mobile_timeline_item}>02</div>
              <div>
                <div className={styles.roadmap_content_item_title}>
                  ACHIEVEMENTS TO DATE
                </div>
            ...
            <div className={styles.roadmap_content_item}>
              <div className={styles.roadmap_content_mobile_timeline_item}>03</div>
              <div>
                <div className={styles.roadmap_content_item_title}>
                  ACHIEVEMENTS TO DATE
                </div>
